...
use Etshy\Rector8237\Rule\MyCustomRule;
...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(AnnotationToAttributeRector::class, [
        new AnnotationToAttribute(
            ...
            'OpenApi\\Attributes\\AdditionalProperties'
        ),
        ...
        new AnnotationToAttribute(
            'OpenApi\\Annotations\\ExternalDocumentation',
            'OpenApi\\Attributes\\ExternalDocumentation'
        ),
        ...
        new AnnotationToAttribute('OpenApi\\Annotations\\QueryParameter', 'OpenApi\\Attributes\\QueryParameter'),
    ...
    //With this, expected result is : #[OA\Property(type: 'array', items: new OA\Items(type: 'integer'))]
    $rectorConfig->ruleWithConfiguration(MyCustomRule::class, [
        [Model::class, "content"],
        [Schema::class, "schema"],
        [Items::class, "items"],
    ]);
